    ...
    <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header class="flex-shrink-0 h-16 bg-panel border-b border-border flex items-center px-4 lg:px-6 gap-4 z-20">
            ...
            <div id="admin-profile-dropdown"
                class="hidden absolute right-0 top-full mt-2 w-56 bg-white border border-orange-100 rounded-2xl shadow-2xl overflow-hidden z-[9999]">
                    ...
                    <div class="px-4 py-3.5 bg-orange-50 border-b border-orange-100">
                        ...
                        <div class="mt-2">
                            <span class="text-[10px] bg-primary-500/20 text-gray-900 font-semibold px-2.5 py-0.5 rounded-full border border-primary-500/20">
                                Administrator
                            </span>
                        </div>
                    </div>
