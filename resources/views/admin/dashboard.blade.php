...
<div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mb-6">
    ...
    <div class="relative glass-card rounded-2xl p-5 stat-card overflow-hidden">
        ...
        <p class="text-white font-bold text-2xl leading-none">{{ number_format($totalThisMonth) }}</p>
    ...
    <div class="relative glass-card rounded-2xl p-5 stat-card overflow-hidden">
        ...
        <p class="text-white font-bold text-2xl leading-none">{{ $pendingCount }}</p>
    ...
    <div class="relative glass-card rounded-2xl p-5 stat-card overflow-hidden">
        ...
        <p class="text-white font-bold text-2xl leading-none">{{ number_format($activeUsers) }}</p>
        <p class="text-slate-600 text-xs mt-1">Customer terdaftar</p>
    </div>
</div>
    ...
    <div class="xl:col-span-2 glass-card rounded-2xl p-5">
        ...
        <div class="flex items-end gap-2 h-36 mb-3">
            ...
            <div class="flex-1 flex flex-col items-center gap-2">
                ...
                <span class="text-slate-500 text-xs font-medium">{{ $d['day'] }}</span>
            </div>
            @endforeach
        </div>
    ...
    <div class="glass-card rounded-2xl p-5">
        ...
        <div class="mt-6 p-4 rounded-xl bg-slate-800/60 border border-border">
            ...
            <p class="text-white font-bold text-xl">
                ...
                <span class="text-slate-500 font-normal text-sm">transaksi</span>
            </p>
            @if($monthGrowthPct >= 0)
...
<div class="grid grid-cols-1 xl:grid-cols-3 gap-4">
    ...
    <div class="xl:col-span-2 glass-card rounded-2xl p-5">
        ...
        <div class="flex flex-col items-center justify-center py-10 text-center">
            ...
            <p class="text-white font-semibold text-sm">Semua Beres!</p>
            <p class="text-slate-500 text-xs mt-1">Tidak ada pembayaran yang menunggu verifikasi</p>
        </div>
        @else
        <div class="space-y-3">
            ...
            <div class="flex items-center gap-3 p-3 rounded-xl bg-slate-800/40 border border-amber-500/10 hover:border-amber-500/30 transition-all">
                ...
                <div class="text-right flex-shrink-0">
                    ...
                    <p class="text-slate-600 text-xs">{{ $payment->created_at->format('H:i') }} WIB</p>
                </div>
        ...
        <div class="glass-card rounded-2xl p-5">
            ...
            <div class="space-y-3">
                <div class="flex items-center gap-3 p-3 rounded-xl bg-slate-800/40">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-slate-500 text-xs">Pemasukan Minggu Ini</p>
                ...
                <div class="flex items-center gap-3 p-3 rounded-xl bg-slate-800/40">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-slate-500 text-xs">Rata-rata per Transaksi</p>
                        <p class="text-white text-sm font-bold">
                ...
                <div class="flex items-center gap-3 p-3 rounded-xl bg-slate-800/40">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-slate-500 text-xs">Hari Transaksi Terbanyak</p>
                        <p class="text-white text-sm font-bold">
                ...
                <div class="flex items-center gap-3 p-3 rounded-xl bg-slate-800/40">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-slate-500 text-xs">Pengguna Bertransaksi</p>
