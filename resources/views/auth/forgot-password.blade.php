...
<body class="min-h-screen bg-gray-100 dot-pattern flex items-center justify-center p-4">
    ...
    {{-- ✅ DIGANTI: tambah animate-fade-up di wrapper --}}
    <div class="relative w-full max-w-md animate-fade-up">

        {{-- ✅ DIGANTI: brand mark pakai logo + teks (opsi 1) --}}
        ...
        {{-- ✅ DIGANTI: card style rounded-2xl shadow-xl, hapus accent bar ungu --}}
        <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/80 border border-gray-100 p-8 animate-fade-up-1">

            {{-- ✅ DIGANTI: header — logo opsi 1 + step indicator tetap ada --}}
            <div class="mb-7 animate-fade-up-1">
                ...
                <div class="flex items-center gap-3 mb-5">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm mt-0.5 leading-relaxed">Verifikasi via Telegram OTP</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-2">
                    <div class="flex items-center gap-2">
                        <div class="w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold bg-orange-500 text-white">1</div>
                        <span class="text-xs font-medium text-orange-600">Nomor HP</span>
                    </div>
                    <div class="flex-1 h-px bg-gray-200"></div>
                    <div class="flex items-center gap-2">
                        <div class="w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold bg-gray-100 text-gray-400 border-2 border-gray-200">2</div>
            ...
            <form method="POST" action="{{ route('password.phone') }}" class="space-y-5" novalidate>
                ...
                <div class="flex items-start gap-3 p-3.5 bg-orange-50 border border-orange-100 rounded-xl">
                    ...
                    <p class="text-xs text-orange-700 leading-relaxed">
                        Pastikan nomor HP sudah terhubung ke akun Telegram Anda. Kode OTP berlaku selama <strong>60 detik</strong>.
                    </p>
                </div>
