...
<body class="min-h-screen bg-gray-100 dot-pattern flex items-center justify-center p-4">
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
        <div class="absolute -top-40 -right-32 w-96 h-96 bg-green-200 rounded-full opacity-30 blur-3xl"></div>
        <div class="absolute -bottom-40 -left-32 w-96 h-96 bg-emerald-100 rounded-full opacity-40 blur-3xl"></div>
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-teal-100 rounded-full opacity-20 blur-3xl"></div>
    </div>
    ...
    <div class="relative w-full max-w-md">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            {{-- Card top accent bar --}}
            <div class="h-1 w-full bg-gradient-to-r from-green-400 via-emerald-500 to-teal-400"></div>
            ...
            <div class="p-8">
                ...
                <div class="mb-7 animate-fade-up-1">
                    ...
                    <p class="text-gray-500 text-sm mt-1.5 leading-relaxed">Daftar untuk mulai menggunakan aplikasi</p>
                </div>
                ...
                <form method="POST" action="{{ route('register.post') }}" class="space-y-5" novalidate>
                    ...
                    <div class="animate-fade-up-3">
                        ...
                        <div class="relative">
                            ...
                            <span class="absolute inset-y-0 left-9 flex items-center pointer-events-none">
                                <span class="text-xs font-semibold text-gray-400 border-r border-gray-200 pr-2.5 mr-0 leading-none" style="line-height:1;">+62</span>
                            </span>
                            <input
                                id="phone"
                                type="tel"
                    ...
                    {{-- Terms checkbox --}}
                    <div class="flex items-start gap-2.5 animate-fade-up-5">
                        <input
                            type="checkbox"
                            id="agree"
                            name="agree"
                            class="w-4 h-4 mt-0.5 rounded border-gray-300 text-green-600 focus:ring-green-400 focus:ring-offset-0 cursor-pointer flex-shrink-0"
                        >
                        <label for="agree" class="text-xs text-gray-500 leading-relaxed cursor-pointer">
                            Saya menyetujui
                            <a href="#" class="text-green-600 hover:text-green-700 font-medium hover:underline">Syarat &amp; Ketentuan</a>
                            serta
                            <a href="#" class="text-green-600 hover:text-green-700 font-medium hover:underline">Kebijakan Privasi</a>
                            yang berlaku.
                        </label>
                    </div>
                    ...
                    <div class="animate-fade-up-6">
                        <button type="submit" id="submit-btn"
                            class="btn-register w-full py-2.5 px-4 bg-green-600 hover:bg-green-700 active:scale-[0.98] text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-md shadow-green-200 flex items-center justify-center gap-2">
                ...
                <p class="text-center text-sm text-gray-500">
                    Sudah punya akun?
                    <a href="{{ url('/login') }}"
                       class="text-green-600 hover:text-green-700 font-semibold hover:underline transition-colors ml-1">
                        Login sekarang
                    </a>
                </p>
    ...
    <script>
        ...
        const levels   = [
            ...
            { color: 'bg-green-500',  label: 'Kuat',          text: 'text-green-600' },
        ];
