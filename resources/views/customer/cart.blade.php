...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-28">
    ...
    <div id="cart-empty" class="hidden text-center py-20">
        ...
        <p class="text-gray-400 text-sm max-w-xs leading-relaxed mx-auto mb-6">Yuk tambahkan menu favoritmu dan nikmati makanan lezat dari kantin sekolah!</p>
        <a href="{{ route('customer.menu') }}" class="btn-primary text-white font-heading font-bold px-8 py-3.5 rounded-2xl shadow-lg flex items-center justify-center w-max mx-auto gap-2 text-sm transition-transform hover:scale-105">
        ...
        <div class="border-t border-dashed border-gray-200 pt-4 space-y-4">
            ...
            <a href="{{ route('customer.menu') }}"
               class="flex items-center gap-3 bg-white border-2 border-dashed border-primary-200 hover:border-primary-400 rounded-2xl p-4 transition-all group">
                ...
                <div>
                    <span class="font-heading font-bold text-sm text-primary-600 group-hover:text-primary-700 transition-colors">Tambah Menu Lainnya</span>
                </div>
            </a>

            {{-- Summary (Dari Fitur Baru Temanmu) --}}
            ...
            <button onclick="clearCart()"
                    class="w-full text-xs text-gray-400 hover:text-red-400 font-medium transition-colors py-1.5 flex justify-center items-center">
...
function submitOrder() {
    // FIX: Arahkan ke rute checkout yang benar!
    window.location.href = "{{ route('customer.order.checkout.show') }}";
}
